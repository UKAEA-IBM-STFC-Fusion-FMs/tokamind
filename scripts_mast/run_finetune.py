...
def parse_args_finetune() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Run finetuning for a given task (convention-based configs).")
    parser.add_argument(
        "--task",
        type=str,
        default="_test",
    ...
    parser.add_argument(
        ...
        help="Finetune initialization mode. 'warmstart' requires --model, 'scratch' ignores --model.",
    )
    parser.add_argument(
        "--model",
        type=str,
